      ...
      <group name="Scene">
        <group name="Rig001" scale={0.4}>
          ...
          <group name="root" rotation={[-Math.PI / 2, 0, 0]}>
            <group
              name="body"
              position={[0, 0.034, 0.731]}
              rotation={[Math.PI / 2, 0, 0]}>
                <meshStandardMaterial color={bodyColor}/>
            </group>
              <group
                name="earL"
                position={[0.284, 1.312, 0.451]}
                rotation={[0.348, 0.139, -2.672]}
                >
          ...
          <group
            name="legFL"
            position={[0.358, 0.111, 0.357]}
            rotation={[0, 0, -Math.PI]}>
              <meshStandardMaterial color={legsColor}/>
          </group>
          <group
            name="legBL"
            position={[0.358, 0.111, -0.654]}
            rotation={[0, 0, -Math.PI]}>
              <meshStandardMaterial color={legsColor}/>
          </group>
          <group
